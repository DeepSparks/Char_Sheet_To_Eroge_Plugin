class Config {
    ...
    static get NOVELAI_QUALITY_KEYWORDS() {
        if(!process.env.NOVELAI_QUALITY_KEYWORDS) return ["looking at viewer", "location", "detailed background", "tsunako", "masterpiece", "best quality", "amazing quality", "very aesthetic", "absurdres", "game_cg", "commission", "official style", "best illustration", "photoshop (medium)"];
